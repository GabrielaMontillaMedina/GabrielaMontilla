...
- 🏗️ **Surotec Web** — Full-stack academic management platform with secure role-based access (Spring Boot + React)
- 💳 **Mi Banquito** — Banking simulation system with JWT authentication and real-time transactions (Node.js)
